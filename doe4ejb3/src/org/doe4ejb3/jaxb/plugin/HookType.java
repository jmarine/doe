...
@XmlType(name = "hookType")
@XmlSeeAlso({
    HookHandlerHookType.class,
    DocumentHookType.class,
    BuildSystemHookType.class,
    LogHookType.class,
    IdeListenerHookType.class,
    WizardHookType.class,
    MenuHookType.class,
    PropertyHookType.class,
    EditorHookType.class
})
