// $ANTLR 2.7.6 (20060904): "EJBQLParameterTypes.g" -> "EJBQLParameterTypesLexer.java"$
...
/** */
public class EJBQLParameterTypesLexer extends antlr.CharScanner implements EJBQLTokenTypes, TokenStream
 {
public EJBQLParameterTypesLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public EJBQLParameterTypesLexer(Reader in) {
	this(new CharBuffer(in));
}
public EJBQLParameterTypesLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public EJBQLParameterTypesLexer(LexerSharedInputState state) {
	super(state);
