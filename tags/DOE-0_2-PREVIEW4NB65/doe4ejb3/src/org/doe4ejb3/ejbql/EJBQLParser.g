...
{ node = null; }
    ...
    | ((NOT)? BETWEEN) => node = betweenExpression[left]
    | ((NOT)? LIKE) => node = likeExpression[left]
    | ((NOT)? IN) => node = inExpression[left]
    | (IS (NOT)? NULL) => node = nullComparisonExpression[left]
    | node = emptyCollectionComparisonExpression[left]
    | node = collectionMemberExpression[left]
    ;

betweenExpression [Object left] returns [Object node]
{ 
    node = null; 
    Object lower, upper;
}
    : ( n:NOT )? t:BETWEEN 
        ...
        { 
            node = factory.newBetween(t.getLine(), t.getColumn(), 
                                      (n!=null), left, lower, upper); 
        }
    ;

inExpression [Object left] returns [Object node]
{ 
    node = null;
...
likeExpression [Object left] returns [Object node]
{ 
    node = null; 
    Object pattern, escape = null;
}
    : ( n:NOT )? t:LIKE pattern = likeValue
        (escape = escape)?
        { 
            node = factory.newLike(t.getLine(), t.getColumn(), (n!=null), 
                                   left, pattern, escape); 
        }
    ;
...
nullComparisonExpression [Object left] returns [Object node]
{ node = null; }
    : t:IS ( n:NOT )? NULL
        { node = factory.newIsNull(t.getLine(), t.getColumn(), (n!=null), left); }
    ;

emptyCollectionComparisonExpression [Object left] returns [Object node]
{ node = null; }
    : t:IS ( n:NOT )? EMPTY
        { node = factory.newIsEmpty(t.getLine(), t.getColumn(), (n != null), left); }
    ;

collectionMemberExpression [Object left] returns [Object node]
{ node = null; }
    : ( n:NOT )? t:MEMBER (OF)? node = collectionValuedPathExpression
        { 
